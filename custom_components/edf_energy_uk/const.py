...
# EDF product codes contain underscores (e.g. EDF_EV_FIX_GOELEC_12M_HH), unlike Octopus's hyphenated ones
REGEX_TARIFF_PARTS = "^((?P<energy>[A-Z])-(?P<rate>[0-9A-Z]+)-)?(?P<product_code>[A-Z0-9_-]+)-(?P<region>[A-Z])$"
